...
<template>
  <div :class="['flex flex-col gap-1', block ? 'w-full' : 'inline-flex']">
    ...
    <div class="relative flex items-center">
      ...
      >
        <!-- Oeil ouvert -->
        <svg v-if="!show" :class="iconSizeClasses[size]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
          <circle cx="12" cy="12" r="3"/>
        </svg>
        <!-- Oeil barré -->
        <svg v-else :class="iconSizeClasses[size]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
